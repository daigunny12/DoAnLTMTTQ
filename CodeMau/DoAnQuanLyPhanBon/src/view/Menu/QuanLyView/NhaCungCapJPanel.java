...
import Controller.QuanLy.QuanLyNhaCungCapController;

public class NhaCungCapJPanel extends javax.swing.JPanel {

    public  NhaCungCapJPanel() {
        initComponents();
         QuanLyNhaCungCapController controller = new QuanLyNhaCungCapController(pnTable, btnAdd, txtTimKiem);
        controller.setDateToTable();
        controller.setEvent();
        it = this;
    }

    public static NhaCungCapJPanel it;
