...
import Controller.QuanLy.Add.AddNhaCungCapController;
import view.Menu.QuanLyView.NhaCungCapJPanel;

public class NhaCungCapJFame extends javax.swing.JFrame {

    
    public NhaCungCapJFame(NhaCungCapObj nhaCungCapObj, NhaCungCapJPanel nhaCungCapJPanel ) {
        initComponents();
        AddNhaCungCapController controller = new AddNhaCungCapController(btnSave, lblThongBao, txtTen, txtMa, txtSoNo, txtSDT, txtDiaChi, txtGhiChu);
        controller.setView(nhaCungCapObj);
        controller.setEvent( nhaCungCapJPanel);
    }
    ...
    private void initComponents() {
        ...
        pnView.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông tin nhà cung cấp", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 14))); // NOI18N
        ...
        pnChinhLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnChinhLayout.createSequentialGroup()
                .addGap(22, 22, 22)
                .addComponent(lblThongBao, javax.swing.GroupLayout.PREFERRED_SIZE, 621, javax.swing.GroupLayout.PREFERRED_SIZE)
