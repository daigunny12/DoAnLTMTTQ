...
import Controller.NhapXuatHang.LoadNhaCungCapJFameCrrl;
import view.Menu.NhapHangJPanel;

public class LoadNhaCungCapJFame extends javax.swing.JFrame {

   
    
    public LoadNhaCungCapJFame(NhapHangJPanel nhapHangJPanel) {
        initComponents();
        LoadNhaCungCapJFameCrrl loadnhaCungCapJFameCrrl = new LoadNhaCungCapJFameCrrl(btnOK, pnTable, txtTimKiem, this);
        loadnhaCungCapJFameCrrl.setDateToTable();
        loadnhaCungCapJFameCrrl.setEvnt(NhapHangJPanel.it);
    }
