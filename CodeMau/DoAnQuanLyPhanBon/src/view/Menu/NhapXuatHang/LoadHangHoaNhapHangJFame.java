...
import Controller.NhapXuatHang.LoadHangHoaNhapHangJFameCtrl;

public class LoadHangHoaNhapHangJFame extends javax.swing.JFrame {

    public LoadHangHoaNhapHangJFame(NhapHangJPanel nhapHangJPanel) {
        initComponents();
        LoadHangHoaNhapHangJFameCtrl load = new LoadHangHoaNhapHangJFameCtrl(pnTable, btnAdd, txtSearch, txtSL, txtGiaBan, lblDVT, txtCK, txtThanhTien, lblThongBao);
        load.setDateToTable();
        load.setEvent(nhapHangJPanel);
    }
