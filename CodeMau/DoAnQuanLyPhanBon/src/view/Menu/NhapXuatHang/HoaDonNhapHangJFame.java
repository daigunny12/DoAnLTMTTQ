...
import Controller.NhapXuatHang.HoaDonNhapHangJFameCtrl;

public class HoaDonNhapHangJFame extends javax.swing.JFrame {

    
    public HoaDonNhapHangJFame(NhapHangJPanel nhapHangJPanel, List<CTHDNhapHangObj> listCTHD, HoaDonNhapHangObj hdnhObj, String NCC ,float  TongTien) {
        initComponents();
        HoaDonNhapHangJFameCtrl ctrl = new HoaDonNhapHangJFameCtrl(lblKhachHang, txtTongThanhToan, txtKhachTra, txtConLai, btnLuuVaIn, btnLuuKhongIn, btnHuy, this);
        ctrl.setEvent(hdnhObj, listCTHD, nhapHangJPanel);
        ctrl.setLoad(NCC, TongTien);
