...
public class LoadHangHoaBanHangJFameCtrl {
    ...
    public LoadHangHoaBanHangJFameCtrl(JPanel pnTable, JButton btnAdd, JTextField txtSearch, JTextField txtSL, JTextField txtGiaMua, JLabel lblDVT, JTextField txtCK, JTextField txtThanhTien, JLabel lblThongBao) {
                ...
                if (c >= '0' && c <= '9') {
                    if (txtSL.getText().length() <= 10) {
                        if (txtSL.getText().length() != 0) {
                            if (SLCL > Integer.parseInt(txtSL.getText())) {
                                txtSL.setEditable(true);
                                lblThongBao.setText("...");
                                lblThongBao.setForeground(Color.BLACK);
                            } else {
                                lblThongBao.setText("Số lượng nhiều hơn lưu kho");
    ...
    public void setEvent(BanHangJPanel banHangJPanel) {
