...
{
    public partial class frmBaoCaoHoaDonNhapHang : Form
    {
        private ThongKeBUS thongKeBUS = null;

        public frmBaoCaoHoaDonNhapHang()
        {
            InitializeComponent();
        ...
        private void btnXuat_Click(object sender, EventArgs e)
        {
            ...
            {
                frm_CR_BaoCaoHoaDonNhapHang frm = new frm_CR_BaoCaoHoaDonNhapHang(fromDate, toDate);
                frm.Show();
            }
        }
        ...
        private void dtpFromDate_ValueChanged(object sender, EventArgs e)
        {
            ...
            dgvThongKe.DataSource = thongKeBUS.BaoCaoHoaDonNhapHang(fromDate, toDate);
        }
